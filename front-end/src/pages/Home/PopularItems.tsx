  ...
  return (
    <div className="py-16 bg-gray-50">
      <div className="container">
        ...
        <button className="inline-flex items-center justify-center gap-2h-9 px-4 py-2 rounded-md border text-sm font-medium bg-background text-foreground hover:bg-accent hover:text-accent-foreground transition">Voir tout</button>
      </div>
