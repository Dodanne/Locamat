        ...
        <div className="section-white">
            <div className="container-max">
                ...
                {categories.map((category) => (
                           <Link to={`/rechercher?categorie=${category.id}`}> <div key={category.id} className="flex flex-col items-center gap-3 p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors w-full cursor-pointer">
