            ...
            <div className="container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-gray-600">Trouvez le matériel dont vous avez besoin près de chez vous</p>
                    </div>
                    {/* Etape 2 */}
                    <div className="text-center">
                        <div className="processSteps-icon">
                        ...
                        <p className="text-gray-600">Échangez avec le propriétaire via notre messagerie sécurisée</p>
                    </div>
                    {/* Etape 3 */}
                    <div className="text-center">
                        <div className="processSteps-icon">
                        ...
                        <p className="text-gray-600">Payez en ligne de manière sécurisée et confirmez votre réservation</p>
                    </div>
                    {/* Etape 4 */}
                    <div className="text-center">
                        <div className="processSteps-icon">
                        ...
                        <p className="text-gray-600">Récupérez le matériel et profitez-en en toute sérénité</p>
                    </div>
                </div>
            </div>
        </div>
