    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-2">
          2. Notre utilisation du stockage local
        </h2>
        <p>
          LocaMat n'utilise pas de cookies au sens traditionnel du terme. Nous utilisons le
          localStorage (stockage local) de votre navigateur, qui fonctionne différemment :
        </p>
      ...
      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-2">
          3. Données stockées dans le localStorage
        </h2>
      ...
      <div>
        ...
        <p>
          Stripe (notre prestataire de paiement) peut déposer des cookies lors du processus de
          paiement. Consultez la politique de confidentialité de Stripe.
        </p>
      </div>

      <div>
        <h2 className="text-xl font-semibold text-gray-900 mb-2">
          5. Supprimer vos données locales
        </h2>
      ...
      <div>
        ...
        <p>
          Pour toute question : <a className="text-accent underline">dorianelacaud@gmail.com</a>
        </p>
      </div>
    </div>
  );
