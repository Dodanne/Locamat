    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-sm text-gray-500 mb-8">Dernière mise à jour : mars 2026</p>
        ...
        <div>
          ...
          <p>LocaMat est responsable du traitement de vos données personnelles. Contact : <a className="text-accent underline">dorianelacaud@gmail.com</a></p>
        </div>
        ...
        <div>
          ...
          <p>Le traitement est fondé sur l'exécution du contrat (CGU) que vous avez accepté lors de votre inscription.</p>
        </div>

        <div>
          <h2 className="text-xl font-semibold text-gray-900 mb-2">5. Durée de conservation</h2>
          <p>Vos données sont conservées pendant toute la durée de votre compte, puis 5 ans après sa suppression pour des raisons légales.</p>
        </div>
        ...
        <div>
          ...
          <p className="mt-2">Pour exercer ces droits : <a className="text-accent underline">dorianelacaud@gmail.com</a></p>
        </div>
