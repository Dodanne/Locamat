...
export default function AddEquipment() {
  const { postNewEquipment } = EquipmentApiContext();
        ...
        <div className="flex flex-col gap-6 rounded-xl border bg-white p-6">
          ...
          <div className="form-div">
            ...
            >
              ...
              {categories.map((cat) => (
                <option value={cat.category_id} className="bg-white text-black ">
                  {cat.name}
                </option>
              ))}
            </select>
          ...
          <div className="form-div relative">
            ...
            <p className="text-sm text-gray-500">
              Montant qui sera bloqué et restitué après retour du matériel
            </p>
          </div>
        </div>
